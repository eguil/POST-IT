...
;
; @keyword GWS {in}{optional}
; global wavelet spectrum. If input then this is used
;          as the theoretical background spectrum,
;          rather than white or red noise.
;
; @keyword CONFIDENCE {in}{optional}
; if set, then return a Confidence INTERVAL.
...
;
; @keyword FFT_THEOR {out}{optional}
; output theoretical red-noise spectrum as fn of PERIOD.
;
...
;
; @version
; $Id: wave_signif.pro 203 2010-01-25 13:44:20Z pinsard $
;
;-
FUNCTION wave_signif, y, dt, scale, sigtest $
        , MOTHER=mother  $
        , PARAM=param $
        , LAG1=lag1 $
        , SIGLVL=siglvl $
