...
;       , XSTYLE=1,XTITLE='Time',YTITLE='Period' $
;       , TITLE='Noise Wavelet' $
...
;
; @version
; $Id: wavelet.pro 203 2010-01-25 13:44:20Z pinsard $
;
;-
FUNCTION morlet $
...
;
; @keyword YPAD {out}{optional}
; returns the padded time series that was actually used in the
;         wavelet transform.
;
; @keyword DAUGHTER {inout}
; if initially set to 1, then return the daughter wavelets.
