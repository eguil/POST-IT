...
;
; @todo
; why not use <propost_it>eos</propost_it> ?
;
; @history
;       Maurice Imbard
...
;
; @version
; $Id: make_eos.pro 205 2010-01-26 09:46:13Z pinsard $
;
;-
FUNCTION make_eos, file_name, ncdf_db $
         , BOXZOOM=boxzoom $
         , TIME_1=time_1 $
         , TIME_2=time_2 $
         , ALL_DATA=all_data $
...
@com_eg
;
 usage='result=make_eos(file_name, ncdf_db ' $
         + ', BOXZOOM=boxzoom ' $
         + ', TIME_1=time_1 ' $
         + ', TIME_2=time_2 ' $
         + ', ALL_DATA=all_data ' $
